...
from sudden_warming_model import run_model  # noqa: E402
...
with tab_timeheight:
    ...
    with left:
        ...
        pcm = ax1.pcolormesh(t_days, out.z_km, out.ubtime, shading="auto", cmap = 'RdBu', vmin = -80, vmax = 80)
    ...
    with right:
        ...
        pcm2 = ax2.pcolormesh(t_days, out.z_km, out.psitime, shading="auto")
